...
function touchEventHandler(
  event: { type: any; touches: string | any[] },
...
function startMainPage(canvas: Element) {
...
class GameUIManager {
  ...
  updateGameTurn(turnNo: number) {
    ...
    if (!this.turnCounterContainer) {
      this.turnCounterContainer = document.querySelector(
  ...
  setPlayerList(playerList: Player[]) {
    ...
    if (!this.playerInfoContainer) {
      this.playerInfoContainer = document.querySelector(
        "#all_players_info_container"
      );
    }
